...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        lista de tipo Alumno y se le pregunta al usuario si quiere crear otro 
        Alumno o no.
        ...
        Si está en la lista, se llama al método. Dentro del método se usará la 
        lista notas para calcular el promedio final de alumno. Siendo este
        promedio final, devuelto por el método y mostrado en el main.
        */
        AlumnoServicio svAlu= new AlumnoServicio();
        ArrayList<Alumno> listaAlumnos= svAlu.crearAlumnos();
        
        System.out.println("Nota final: "+ svAlu.notaFinal(listaAlumnos));
    }
