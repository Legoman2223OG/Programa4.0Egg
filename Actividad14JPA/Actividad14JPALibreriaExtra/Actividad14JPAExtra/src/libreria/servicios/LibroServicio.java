...
public class LibroServicio extends DAO<Libro>{
    ...
    public void CrearLibro(long isbn,String titulo,int anio, int ejemplares,int idautor,int ideditorial) throws Exception{
        ...
        if(anio <0 || ejemplares <0 || idautor < 0 || ideditorial < 0 || isbn < 0)
