...
public class ActividadEjemplo2 {
    ...
    de una bomba para mover fluidos). Definir una variable tipoMotor 
...
o	Si no se cumple ninguno de los valores anteriores mostrar el mensaje “No existe un valor válido para tipo de bomba”
    */
    public static void main(String[] args){
        int tipoMotor;
        System.out.println("Introduce el tipo de motor (1-4)");
        tipoMotor= new Scanner(System.in).nextInt();
        switch(tipoMotor){
            case 1:
