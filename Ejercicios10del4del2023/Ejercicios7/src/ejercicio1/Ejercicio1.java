...
public class Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        vacío y con atributo frase solamente. Agregar getters y setters. 
        El constructor con frase como atributo debe setear la longitud de la 
        frase de manera automática. Crear una clase CadenaServicio en el paquete
        ...
        usuario.
        E) Método unirFrases(String frase), deberá unir la frase contenida en 
        ...
        falso si no
        */
        Cadena cadenaNueva= new Cadena("Casa Blanca");
        CadenaServicio sv= new CadenaServicio();
        sv.mostrarVocales(cadenaNueva);
        sv.invertirFrase(cadenaNueva);
        sv.vecesRepetido(cadenaNueva, "B");
        sv.compararLongitud(cadenaNueva, "Casa Blanca");
        sv.unirFrases(cadenaNueva, " Bien blanca");
        sv.reemplazar(cadenaNueva, "ja");
        System.out.println(sv.contiene(cadenaNueva, "a"));
    }
